...
public class GameState {
	 ...
	 * and false otherwise.
	 */
	public boolean isFinished(){ //IsTerminal
	 ...
	 */
	public int[] countTokens(){ //UTILITY
    	int tokens1 = 0;
    	int tokens2 = 0;
    	for (int i = 0; i < size; i++){
    		for (int j = 0; j < size; j++){
	 ...
	 */
    public boolean insertToken(Position place) { //ACTION 
     ...
     */
    private int captureInDirection(Position p, int deltaX, int deltaY){ //MiniMaxValue
